...
namespace RssFeeder.Mvc.Handlers
{
    public class GetFeedHandler : IRequestHandler<GetFeedQuery, string>
    {
        ...
        private readonly IEnumerable<string> _collectionList = new string[] { "drudge-report", "eagle-slant", "bongino-report", "liberty-daily", "citizen-freepress", "rantingly", "gutsmack", "populist-press", "revolver-news", "freedom-press", "conservagator" };
